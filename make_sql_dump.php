...
function make_backup_files ($mysqlHostName, $mysqlDatabaseName, $mysqlUserName, $mysqlPassword) {
    ...
    exec('tar -zvc -C ../ -f ../../site.tgz site',$output=array(),$worked);
    if ($worked > 0) { // check return code
...
$retval = make_backup_files($mysqlHostName, $mysqlDatabaseName, $mysqlUserName, $mysqlPassword);
if ($retval == 0) {
